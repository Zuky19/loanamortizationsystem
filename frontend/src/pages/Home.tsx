...
export function Home() {
  return (
    <div
      className="relative w-full h-full bg-[#EBF0F3] overflow-hidden flex justify-center items-center"
      style={{ transform: "scale(1)", transformOrigin: "top left" }}
    >
      <div className="relative w-[1364px] h-[1024px]">
        ...
        {/* Social Icons */}
        <div className="absolute w-[134px] h-[30px] left-[86px] top-[941px] flex gap-[10px] z-[10]">
          {/* Instagram */}
          <div className="w-[30px] h-[30px] bg-transparent flex items-center justify-center rounded-full border border-gray-300">
        ...
        <div className="absolute top-[-4px] left-[699px] w-[730px] h-[1271px] z-[2]">
          <div className="absolute w-full h-full rounded-r-[35px]">
            <img
              src={PayupIcon}
              alt="Payup"
